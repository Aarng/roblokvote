...
const curatedCharacters = {
  melee: [
    ...
    { name: "Toji Fushiguro", anime: "JUJUTSU KAISEN Season 2" },
    { name: "Naoya Zenin", anime: "JUJUTSU KAISEN" },
    { name: "Naruto Uzumaki", anime: "Naruto" },
    { name: "Rock Lee", anime: "Naruto" },
    { name: "Son Goku", anime: "Dragon Ball Z" },
    { name: "Vegeta", anime: "Dragon Ball Z" },
    { name: "Broly", anime: "Dragon Ball Super: Broly" },
    { name: "Gohan", anime: "Dragon Ball Z" },
    { name: "Piccolo", anime: "Dragon Ball Z" },
    { name: "Gon Freecss", anime: "Hunter x Hunter (2011)" },
    { name: "Killua Zoldyck", anime: "Hunter x Hunter (2011)" },
    ...
    { name: "Akaza", anime: "Demon Slayer -Kimetsu no Yaiba- The Movie: Mugen Train" },
    { name: "Ban", anime: "The Seven Deadly Sins" },
    { name: "All Might", anime: "My Hero Academia" },
    { name: "Izuku Midoriya", anime: "My Hero Academia" },
    { name: "Mirko", anime: "My Hero Academia Season 4" },
    { name: "Eren Yeager", anime: "Attack on Titan" },
    { name: "Joseph Joestar", anime: "JoJo's Bizarre Adventure (TV)" },
    { name: "Jonathan Joestar", anime: "JoJo's Bizarre Adventure (TV)" },
    { name: "DIO", anime: "JoJo's Bizarre Adventure (TV)" },
    { name: "Yujiro hanma", anime: "BAKI" },
  ...
  espada: [
    ...
    { name: "Ichigo", anime: "BLEACH" },
    { name: "Biakuya Kuchiki", anime: "BLEACH" },
    ...
    { name: "Tanjiro Kamado", anime: "KIMETSU NO YAIBA" },
    { name: "Giyu Tomioka", anime: "KIMETSU NO YAIBA" },
    { name: "Kyojuro Rengoku", anime: "KIMETSU NO YAIBA" },
    { name: "Muichiro Tokito", anime: "KIMETSU NO YAIBA" },
    { name: "Zenitsu Agatsuma", anime: "KIMETSU NO YAIBA" },
    { name: "Yoriichi Tsugikuni", anime: "KIMETSU NO YAIBA" },
    ...
    { name: "Kirito", anime: "SAO" },
    { name: "Asuna Yuuki", anime: "SAO" },
    { name: "Guts", anime: "BERSERK" },
    { name: "Griffith", anime: "BERSERK" },
    { name: "Kenshin Himura", anime: "SAMURAI X" },
    ...
    { name: "B2", anime: "NIER: AUTOMATA" },
    { name: "Saber", anime: "FATE" },
    ...
    { name: "Inosuke Hashibira", anime: "Demon Slayer: Kimetsu no Yaiba" },
    { name: "Escanor", anime: "The Seven Deadly Sins: Revival of the Commandments" },
  ...
  magia: [
    ...
    { name: "Suguru Geto (kenjaku?)", anime: "JUJUTSU KAISEN" },
    { name: "Mahito", anime: "JUJUTSU KAISEN" },
    { name: "Choso", anime: "JUJUTSU KAISEN" },
    { name: "Megumin", anime: "KONOSUBA -God's blessing on this wonderful world!" },
    ...
    { name: "Milim Nava", anime: "Tensei shitara Slime Datta Ken" },
    ...
    { name: "Madoka Kaname", anime: "Mahou Shoujo Madoka★Magica" },
    { name: "Homura Akemi", anime: "Mahou Shoujo Madoka★Magica" },
    { name: "Mami Tomoe", anime: "Mahou Shoujo Madoka★Magica" },
    { name: "Ainz Ooal Gown", anime: "Overlord" },
    { name: "Emilia", anime: "Re zero" },
    { name: "Beatrice", anime: "Re zero" },
    { name: "Roxy Migurdia", anime: "Mushoku Tensei: Isekai Ittara Honki Dasu" },
    { name: "Rudeus Greyrat", anime: "Mushoku Tensei: Isekai Ittara Honki Dasu" },
